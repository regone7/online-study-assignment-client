...
const MarkPage = () => {
    ...
    // console.log(markes)
    const { link_submit, note_text, status, email, examinee_name,atitle,amarks } =markes;
    return (
        <div>
                        ...
                        <div className="card-body -mt-5">
                            <form  >
                                ...
                                <div className="form-control">
                                    ...
                                    <select defaultValue={status} name="category"  className="h-12 p-3 input-bordered " required >
